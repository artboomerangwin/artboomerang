...
private:
    ...
    uint64_t nWeight;
    /** Blocks loading spinner progress */
    int spinnerFrame;
    QTimer *spinnerTimer;
    QTimer *copyingProgressTimer;
    int copyingProgressSize;
    QProgressDialog *copyingProgress;
...
public slots:
    BitScreen* screenParameters(){return screen;}
...
private slots:
    ...
    void updateSpinner();
    void updateCopyingProgress(qint64 w);
    void updateCopyingProgress();
